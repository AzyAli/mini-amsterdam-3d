...
export declare const CesiumIonLoader: {
    ...
    readonly parse: (data: ArrayBuffer, options?: LoaderOptions | undefined, context?: import("@loaders.gl/loader-utils").LoaderContext | undefined) => Promise<import("../src/types").Tiles3DTilesetJSONPostprocessed | import("../src/types").Tiles3DTileContent>;
    readonly options: {
        readonly 'cesium-ion': {
