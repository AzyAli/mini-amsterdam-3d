import type { Draco3D, Encoder, Mesh, MeshBuilder, PointCloud, Metadata, MetadataBuilder, draco_GeometryAttribute_Type } from "../../src/draco3d/draco3d-types.js";
import type { TypedArray } from '@loaders.gl/schema';
import type { DracoMesh } from "../../src/lib/draco-types.js";
...
export default class DracoBuilder {
    ...
    _getAttributesFromMesh(mesh: DracoMesh): {
        ...
        loaderData: {
            [key: string]: any;
        } & import("../../src/lib/draco-types.js").DracoLoaderData;
        header?: {
            vertexCount: number;
